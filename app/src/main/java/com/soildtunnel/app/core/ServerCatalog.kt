...
object ServerCatalog {
    ...
    val psiphonNodes: List<ServerNode> = listOf(
        ...
        ServerNode("ps-us-03", "United States 3", "PS-US-03", "US", listOf("162.159.199.0/24"), "162.159.199.1"),
        ServerNode("ps-ca-01", "Canada", "PS-CA-01", "CA", listOf("162.159.200.0/24"), "162.159.200.1"),
        ServerNode("ps-ca-02", "Canada 2", "PS-CA-02", "CA", listOf("162.159.201.0/24"), "162.159.201.1"),
        ServerNode("ps-de-01", "Germany", "PS-DE-01", "DE", listOf("162.159.202.0/24"), "162.159.202.1"),
        ServerNode("ps-de-02", "Germany 2", "PS-DE-02", "DE", listOf("188.114.100.0/24"), "188.114.100.1"),
        ServerNode("ps-nl-01", "Netherlands", "PS-NL-01", "NL", listOf("162.159.203.0/24"), "162.159.203.1"),
        ServerNode("ps-uk-01", "United Kingdom", "PS-GB-01", "GB", listOf("162.159.205.0/24"), "162.159.205.1"),
        ServerNode("ps-fr-01", "France", "PS-FR-01", "FR", listOf("162.159.206.0/24"), "162.159.206.1"),
        ServerNode("ps-fr-02", "France 2", "PS-FR-02", "FR", listOf("188.114.101.0/24"), "188.114.101.1"),
        ServerNode("ps-tr-01", "Turkey", "PS-TR-01", "TR", listOf("162.159.207.0/24"), "162.159.207.1"),
        ServerNode("ps-pl-01", "Poland", "PS-PL-01", "PL", listOf("162.159.208.0/24"), "162.159.208.1"),
        ServerNode("ps-se-01", "Sweden", "PS-SE-01", "SE", listOf("188.114.102.0/24"), "188.114.102.1"),
        ServerNode("ps-fi-01", "Finland", "PS-FI-01", "FI", listOf("188.114.103.0/24"), "188.114.103.1"),
        ServerNode("ps-ch-01", "Switzerland", "PS-CH-01", "CH", listOf("188.114.104.0/24"), "188.114.104.1"),
        ServerNode("ps-at-01", "Austria", "PS-AT-01", "AT", listOf("188.114.105.0/24"), "188.114.105.1"),
        ServerNode("ps-it-01", "Italy", "PS-IT-01", "IT", listOf("188.114.106.0/24"), "188.114.106.1"),
        ServerNode("ps-jp-01", "Japan", "PS-JP-01", "JP", listOf("162.159.209.0/24"), "162.159.209.1"),
        ServerNode("ps-sg-01", "Singapore", "PS-SG-01", "SG", listOf("162.159.210.0/24"), "162.159.210.1"),
        ServerNode("ps-au-01", "Australia", "PS-AU-01", "AU", listOf("162.159.211.0/24"), "162.159.211.1"),
        ServerNode("ps-br-01", "Brazil", "PS-BR-01", "BR", listOf("188.114.107.0/24"), "188.114.107.1"),
        ServerNode("ps-in-01", "India", "PS-IN-01", "IN", listOf("188.114.108.0/24"), "188.114.108.1"),
        ServerNode("ps-ae-01", "UAE", "PS-AE-01", "AE", listOf("188.114.109.0/24"), "188.114.109.1"),
        ServerNode("ps-hk-01", "Hong Kong", "PS-HK-01", "HK", listOf("188.114.110.0/24"), "188.114.110.1"),
    )
