...
**New features:**
- **Tor mode** — route the whole device through the Tor network: pick Tor as the protocol and pin an exit country. The exit can be switched live from the home screen while connected.
...
- The app is bigger this release: it now ships the Tor daemon and Tor's country database.
